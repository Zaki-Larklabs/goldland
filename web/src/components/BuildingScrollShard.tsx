...
const PANELS = [
  { tag: "Goldland Excellence",       h: "Shaping\nDubai's Skyline.",    sub: "Pioneering engineering solutions that redefine modern infrastructure.", from: 0.00, to: 0.18, side: "l" },
  { tag: "Authority Experts",         h: "Seamless\nCompliance.",        sub: "Fast-tracking your permits across DDA, Trakhees, and Dubai Municipality.", from: 0.22, to: 0.38, side: "r" },
  { tag: "Structural Integrity",      h: "Built to\nLast.",              sub: "Uncompromising quality control and structural validation for every project.", from: 0.42, to: 0.58, side: "l" },
  { tag: "Turnkey Solutions",         h: "Execution\nPerfected.",        sub: "Delivering complex builds on time and strictly within regulatory codes.", from: 0.62, to: 0.78, side: "r" },
  { tag: "Next Steps",                h: "Realize Your\nVision.",        sub: "Get a free technical assessment and approval roadmap today.", from: 0.84, to: 1.00, side: "c", cta: true },
] as const;
...
// ─── Main ─────────────────────────────────────────────────────────────────────
export default function BuildingScrollShard() {
