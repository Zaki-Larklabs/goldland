...
const BuildingScrollShard = dynamic(
  () => import("@/components/BuildingScrollShard"),
  {
    ssr: false,
    loading: () => (
      <div 
      ...
      >
        ...
        <div className="relative z-10 text-center text-white px-4">
          ...
          <h2 className="text-4xl md:text-6xl font-bold mb-4 leading-tight">
            Shaping<br />Dubai's Skyline.
          </h2>
          <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto mb-8 leading-relaxed">
            Pioneering engineering solutions that redefine modern infrastructure.
          </p>
...
export default function BuildingScrollShardClient() {
  return <BuildingScrollShard />;
}
